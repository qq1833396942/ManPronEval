...
def test_best_model_large():
    ...
    # 替换为 Large 模型路径
    LOCAL_MODEL_PATH = r"D:\develop\HuBERT_fun\hubert-large\models--facebook--hubert-large-ls960-ft\snapshots\ece5fabbf034c1073acae96d5401b25be96709d8"
    ...
    # 🚨 指向 Large 模型的保存权重
    BEST_WEIGHTS = os.path.join(BASE_DIR, 'mtl_model_large_best_final.pth')
