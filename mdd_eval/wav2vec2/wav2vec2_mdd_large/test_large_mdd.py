...
from model_large import MDD_Wav2vec_Large_LoRA_Model
...
MODEL_WEIGHTS = "best_wav2vec2_large_lora_mdd.pth" 
...
def main():
    ...
    model = MDD_Wav2vec_Large_LoRA_Model(
        num_pinyins=vocab_size, 
        wav2vec2_version=LOCAL_WAV2VEC2_PATH
    )
