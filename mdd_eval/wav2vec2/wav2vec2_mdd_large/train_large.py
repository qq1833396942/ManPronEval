...
from mdd_eval.wav2vec2.wav2vec2_mdd_large.model_large import MDD_Wav2vec_Large_LoRA_Model
# 🚨 导入新的 Large + LoRA 模型
...
PARAMS = {
    ...
    "epochs": 20,
    "patience": 3,
    "save_path": "best_wav2vec2_large_lora_mdd.pth",
    "checkpoint_name": "wav2vec2_large_lora_checkpoint.pth"
}
...
def main():
    ...
    # 3. 初始化与优化器配置
    # ==========================================
    model = MDD_Wav2vec_Large_LoRA_Model(num_pinyins=vocab_size, wav2vec2_version=LOCAL_WAV2VEC2_PATH).to(device)
