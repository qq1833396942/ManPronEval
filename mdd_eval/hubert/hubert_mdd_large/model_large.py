...
class MDD_HuBERT_Large_LoRA_Model(nn.Module):
    def __init__(self, num_pinyins, hubert_version="facebook/hubert-large-ls960-ft"):
        super().__init__()
        print(f"🧬 Model 3 (Large + LoRA + Attention) 初始化中... [HuBERT 版]")
        ...
        self.hubert.print_trainable_parameters() # 打印一下参数量，你会发现只有约 1% 被训练

        # 获取音频特征维度 (HuBERT Large 为 1024)
