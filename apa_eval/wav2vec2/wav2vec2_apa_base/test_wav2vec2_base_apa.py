...
MODEL_WEIGHTS = "best_wav2vec2_base_v2_explicit.pth" # 确保这是你刚刚练出来的包含三头打分的最新权重
...
def main():
    ...
    # 3. 初始化模型并加载权重
    model = APA_Wav2vec2_Base_Model(num_pinyins=vocab_size, wav2vec2_version=LOCAL_wav2vec2_PATH)
